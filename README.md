...
| 8 | US-34 | Calcular huella de carbono | Como analista ambiental, quiero calcular automáticamente la huella de carbono utilizando los datos registrados, para obtener los resultados de emisiones de la organización. | 5 |
...
| 40 | TS-01 | Registrar emisión mediante EcoTrack API | Como Developer, quiero enviar registros de emisiones mediante la EcoTrack API, para integrar sistemas empresariales externos con EcoTrack. | 5 |
